...
import { Animated, StyleSheet, PanResponder, View, Easing, Platform } from 'react-native';
...
var Slider = React.createClass({
  ...
  _renderDebugThumbTouchRect(thumbLeft) {
    ...
    return (
      <Animated.View
        style={[defaultStyles.debugThumbTouchArea, positionStyle, defaultStyles.shadow]}
        pointerEvents='none'
      />
    );
  }
